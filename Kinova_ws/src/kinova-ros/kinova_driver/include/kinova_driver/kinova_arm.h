...
class KinovaArm
{
 public:
    ...
    float getCartesianZ();  // 获取末端的z坐标
    float getCartesianX();  // 获取末端的x坐标
    void getCartesianPos(KinovaPose& position);  // 获取末端的坐标
    bool setFingerPos(float finger1, float finger2, float finger3);  // 设置手指位置
